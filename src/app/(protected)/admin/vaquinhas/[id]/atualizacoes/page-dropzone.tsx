...
import { NovaAtualizacaoForm } from "./nova-form-dropzone";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-4 mt-1">
          <p className="text-zinc-400">Thread de atualizações (REACT DROPZONE)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4">Nova Atualização (REACT DROPZONE)</h2>
