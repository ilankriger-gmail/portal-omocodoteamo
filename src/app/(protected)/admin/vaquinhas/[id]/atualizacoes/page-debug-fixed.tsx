...
import { NovaAtualizacaoFormDebugFixed } from "./nova-form-debug-fixed";
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-4 mt-1">
          <p className="text-zinc-400">Thread de atualizações (DEBUG FIXED)</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-lg font-semibold mb-4">Nova Atualização (DEBUG FIXED)</h2>
            <NovaAtualizacaoFormDebugFixed vaquinhaId={id} />
          </div>
        </div>
      </div>
    </div>
